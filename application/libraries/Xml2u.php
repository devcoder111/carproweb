...
class Xml2u {
     ...
     */
    public function import($filename=null, $overwrite = FALSE, $activated = TRUE, $google_gps = TRUE, $max_images=1, $user_id=NULL, $offset= FALSE, $limit = FALSE, $developer_mode = FALSE) {
        ...
        $file = $this->file_get_contents_curl($filename);
