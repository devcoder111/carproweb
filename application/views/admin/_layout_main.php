    ...
    <div class="containerk">
      <!-- Menu button for smallar screens -->
		<div class="navbar-header">
		  ...
		  <a href="<?php echo site_url('admin/dashboard')?>" class="navbar-brand"><img src="<?php echo base_url('admin-assets/img/custom/logo-system-mini.png');?>" />Business <span class="bold">Directory</span></a>
		</div>
