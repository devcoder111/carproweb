...
//                    else 
                    if($val != "")
                    {
                        ...
                        {
                            if(config_item('search_by_coma_enabled') === TRUE){
                                ...
                                $query ='';
                                    ...
                                    $query .="(".$this->db->dbprefix."property.id = '$_val_parse' OR ".$this->db->dbprefix."property.address LIKE '%$_val_parse%' OR search_values LIKE '%$_val_parse%')";
                                    }
                                if(!empty($query)){
                                        $query .=')';
                                        $this->db->where($query);
                                ...
                                // without comma
                                $this->db->where("(".$this->db->dbprefix."property.id = '$val' OR ".$this->db->dbprefix."property.address LIKE '%$val%' OR search_values LIKE '%$val%')");  
                            }
