...
<div class="widget widget-styles widget-right-search widget_edit" id='form'>
    {is_logged_other}
    <div class="widget-controls-panel widget_controls_panel" data-widgetfilename="right_customfilter">
        <a href="<?php echo site_url('admin/forms/edit/1');?>" target="_blunk" class="btn btn-edit"><i class="ion-edit"></i></a>
    </div>
    {/is_logged_other}
    <h2 class="widget-title text-center content"><?php echo lang_check('Custom Filter');?></h2>
    <div class="content-box">
        <form class="local-form secondary-form">
        ...
        <?php if(isset($options_name_36)): ?>
             <div class="row hidden">
                <div class="col-sm-6">
                    <div class="form-group">
                            <label><?php _l('Fromprice');?> </label>
                            <input type="text" option_id="36" rel="from" class="form-control input_am_from id_36_from DECIMAL" placeholder="<?php _l('Fromprice');?> ({options_prefix_36}{options_suffix_36})" hidefocus="true">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                            <label><?php _l('Toprice');?> </label>
                            <input type="text" option_id="36" rel="to" class="form-control input_am_from id_36_to DECIMAL" placeholder="<?php _l('Toprice');?> ({options_prefix_36}{options_suffix_36})" hidefocus="true">
                    </div>
                </div>
            </div>
        <?php endif; ?>
        ...
        <?php endif; ?>
           ...
           <?php endif; ?>
            <button type="submit" class="btn btn-custom btn-custom-grey btn-wide refresh_filters"><?php _l('RefreshResults');?></button>
        </form>
    </div>
</div>