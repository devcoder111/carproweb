...
Widget-preview-image: /assets/img/widgets_preview/top_geomap.jpg
*/
...
<?php endif;?>
        ...
        <div class="row">
            <?php if(!$widget_fatal_error):?>
            <div class="col-sm-5 geo-menu">
                <div class="geo-menu-breadcrumb"></div>
                <ul class="treefield-tags">
                    <?php foreach ($treefields as $key => $item) : ?>
                        <li class=''><a href="#<?php echo str_replace(' ', '-', $item['title']); ?>" data-region='<?php _che($item['title']); ?>' data-name-lvl_0="<?php _che($item['title']); ?>" data-path='<?php _che($item['title']); ?> - ' data-id='<?php _che($item['id']); ?>'><?php _che($item['title']); ?></a>
                            <ul class='' id="<?php echo str_replace(' ', '-', $item['title']); ?>">
                                ...
                                ?>
                                    <?php foreach ($item['childs'] as $child): ?>
                                        <li><a href="#" title="<?php _che($child['title']); ?>" data-path-map-origin="<?php _che($tree_listings_default[$child['id']]->value);?>, <?php _che($tree_listings_default[$item['id']]->value);?>" data-path-map="<?php _che($child['title']); ?>, <?php _che($item['title']); ?>" data-region='<?php _che($child['title']); ?>' data-name-lvl_0="<?php _che($item['title']); ?>" data-path='<?php _che($item['title']); ?> - <?php _che($child['title']); ?>' data-id='<?php _che($child['id']); ?>'><?php _che($child['title']); ?> <span class="item-count">(<?php _che($child['count']); ?>)</span></a>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </ul>
                        </li>
