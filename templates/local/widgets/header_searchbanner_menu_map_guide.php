 <?php
/*
Widget-title: Searchbanner with menu for City Guide, bg map
Widget-preview-image: /assets/img/widgets_preview/header_searchbanner_menu_map.jpg
 */
?>
...
<?php
    ...
    if(isset($options_name_79)){
        ...
        $treefield_id = 4;
        foreach ($options_values_arr_4 as $key => $value) {
            $treefield = array();
...
<div class="container container-palette top-bar overflow top-bar-white t-overflow affix-menu widget_edit_enabled">
...
<div class="section-search-area section container container-palette">
    <div id="map_bg" class="map-bg" data-location="{settings_gps}"></div>
    <div class="container">
               <div class="body">
            <div class="h-area">
            ...
            <div class="local-form redirect_search">
                <form action="{page_current_url}#main-search" class="search-form">
