<?php
/*
Widget-title: Categories with preview #79, (search will be redirect)
...
foreach ($_treefields as $val) {
    ...
    {
        $treefield['thumbnail_url'] = 'assets/img/categories/default.jpg';
        $treefield['image_url'] = 'assets/img/categories/default.jpg';
        $treefield['thumbnail_url_second'] = 'assets/img/icon/category.png';
        $treefield['image_url_second'] = 'assets/img/icon/category.png';
    }
