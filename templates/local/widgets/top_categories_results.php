 <?php
/*
Widget-title: Categories results
Widget-preview-image: /assets/img/widgets_preview/top_categories_results.jpg
 */
?>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="thumbnail thumbnail-property">
                <div class="thumbnail-image">
                    <img src="<?php echo _simg($item['thumbnail_url'], '380x250'); ?>" alt="<?php _che($item['title']); ?>" />
                ...
                <div class="caption caption-blog">
                    <h3 class="thumbnail-title"><a href="<?php echo $item['url']; ?>"><?php _che($item['title']); ?></a></h3>
                    <div class="date">
                        <ul class="treefield-categories-list">
                            <?php if (sw_count($item['childs_8']) > 0) foreach ($item['childs_8'] as $child): ?>
                                ...
                                <?php else:?>
                                <li>
                                    <a class="treefield-box-item btn-default" href='<?php echo site_url($lang_code.'/'.config_db_item("results_page_id").'/?search=%7B"v_search_option_'.$treefield_id.'":"'.rawurlencode($item['title'].' - '.$child['title'].' - ').'"%7D'); ?>'><?php _che($child['title']); ?></a>
                                    <span class="count text-color-primary"><?php _che($child['count']);?></span>
                                </li>
                                <?php endif;?>
                            <?php endforeach; ?>
