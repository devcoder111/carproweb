 <?php
/*
Widget-title: Top Categories #79
Widget-preview-image: /assets/img/widgets_preview/bottom_categories.jpg
 */
?>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="card card-category">
                    <a href='<?php _che($item['url']);?>'>
                        <img src="<?php _che($item['thumbnail_url']);?>" class="image-cover" alt="<?php _che($item['title']);?>" />
