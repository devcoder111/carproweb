 <?php
/*
Widget-title: Categories #64
Widget-preview-image: /assets/img/widgets_preview/top_categories2.jpg
 */
?>
        ...
        <div class="row result-container row-flex">
            ...
            <div class="col-md-4 col-sm-6">
                <figure class="card card-preview">
                    <img src="<?php _che($item['image_url']);?>" class="image-cover" alt="<?php _che($item['title']);?>" />
                    <a href='<?php _che($item['url']);?>' class="link"></a>
                    <figcaption class="description">
                        <h2><?php _che($item['title']);?></h2>
                        <p><?php _che($item['description_chlimit'], lang_check('This can be small description'));?></p>
                    </figcaption>
                </figure>
            </div>            
            <?php $i++; endforeach; ?>
