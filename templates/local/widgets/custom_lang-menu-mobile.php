...
?> 
    ...
    {
        $flag_icon = '&nbsp; <img class="flag-icon" src="'.'assets/img/flags/'.$this->data['lang_code'].'.png" alt="'.$this->data['lang_code'].'" />';
    }

    if ( ! function_exists('get_lang_menu_mobile_custom'))
    {
    function get_lang_menu_mobile_custom($array, $lang_code, $extra_ul_attributes = '')
        {
            $CI =& get_instance();
            $property_data = NULL;
            ...
            foreach ($array as $item) {
                ...
                if(isset($CI->data['settings_template']))
                {
                    ...
                    {
                        $flag_icon = '&nbsp; <img src="'.'assets/img/flags/'.$item['code'].'.png" alt="'.$item['code'].'" />';
                    }
                }
    ...
    ?>
    <?php 
      echo get_lang_menu_mobile_custom($this->language_m->get_array_by(array('is_frontend'=>1)), $this->data['lang_code'], 'class="lang-menu-mobile"');
    ?>
<?php endif;?>