<?php
/*
Widget-title: Mini map results
Widget-preview-image: /assets/img/widgets_preview/right_mapllistings.jpg
 */
?>
...
<div class="widget widget-styles widget-right-map widget_edit_enabled">
    <div class="header b link">
        <h2><a href="<?php echo site_url($lang_code.'/177/map');?>">Open Wide Map</a></h2>
    </div>
    <div class="body">
