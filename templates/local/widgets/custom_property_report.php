...
<?php if(config_item('report_property_enabled') == TRUE && isset($property_id)): ?>
    ...
    <?php if(!is_array($this->session->userdata('reported')) || !in_array($property_id, $this->session->userdata('reported'))): ?>
        <a class="btn btn-custom-s btn-custom-default popup-with-form-report" id="report_property" href="#popup_report_property" style=""><i class="icon-flag"></i> <?php echo lang_check('Claim Listing'); ?> <i class="load-indicator"></i></a>
        <a class="btn btn-custom-s btn-custom-default report-claimed hidden" id="report_claimed_property" href="#"><i class="icon-flag"></i> <?php echo lang_check('Claimed'); ?> <i class="load-indicator"></i></a>
    <?php else: ?>    
        <a class="btn btn-custom-s btn-custom-default report-claimed" id="report_claimed_property" href="#"><i class="icon-flag"></i> <?php echo lang_check('Claimed'); ?> <i class="load-indicator"></i></a>
    <?php endif; ?>    
