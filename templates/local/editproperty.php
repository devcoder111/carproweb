    ...
    <body class="<?php _widget('custom_paletteclass'); ?>">
        ...
        <main class="" id="main">
            <section class="section container container-palette" id="content">
                <div class="container">
                    <div class="row swap-sm-down">
                        <div class="col-sm-8 swap-bottom">
                                <div class="widget widget-styles affix-parent">
                                    ...
                                    <div class="content-box local-form">
                                        ...
                                        <!-- Form starts.  -->
                                        <?php echo form_open(NULL, array('class' => 'form-estate form-editproperty', 'role'=>'form'))?>                              
                                            ...
                                            <div role="tabpanel" style="margin-bottom: 0px;" class="tabbable">
                                                <ul class="nav nav-tabs lang-tabs" data-toggle="affix">
                                                    ...
                                                    foreach ($this->option_m->languages as $key => $val):$i++; ?>
                                                        <li class="nav-item lang rtab <?php echo $i == 1 ? 'active' : '' ?>"><a class="nav-link no-swing <?php echo $i == 1 ? 'active' : '' ?>" data-toggle="tab" href="#lang_id_<?php echo $key ?>"><?php echo $val ?></a></li>
                                                    <?php endforeach; ?>
                                                    ...
                                                    foreach ($this->option_m->languages as $key => $val):$i++; ?>
                                                        ...
                                                        <?php elseif($val_option['type'] == 'INPUTBOX' || $val_option['type'] == 'DECIMAL' || $val_option['type'] == 'INTEGER'):?>
                                                            <div class="form-group<?php echo ($val_option['is_frontend']?'':' hidden') ?>">
                                                                <label for="inputOption_<?php echo $key;?>_<?php echo $val_option['id'];?>" class="control-label"><?php echo $required_notice.$val_option['option']?><?php if(!empty($options_lang[$key][$key_option]->hint)):?><i class="icon-question-sign hint" data-hint="<?php echo $options_lang[$key][$key_option]->hint;?>"></i><?php endif;?></label>
                                                        ...
                                                        <?php elseif($val_option['type'] == 'CHECKBOX'):?>
                                                            <div class="control-group<?php echo ($val_option['is_frontend']?'':' hidden') ?> control-group-checkbox col-sm-2">
                                                                <label for="inputOption_<?php echo $key;?>_<?php echo $val_option['id'];?>" class="control-label"><?php echo $required_notice.$val_option['option']?><?php if(!empty($options_lang[$key][$key_option]->hint)):?><i class="icon-question-sign hint" data-hint="<?php echo $options_lang[$key][$key_option]->hint;?>"></i><?php endif;?></label>
                                                                <?php if($is_not_translatable):?>
                                                                <div class="controls">
                                                                    <div class="alert alert-warning non-translatable" role="alert"><?php echo lang_Check('Not translatable');?></div>
    ...
    if($(window).width()>767){
        ...
        if($('.lang-tabs').hasClass('affix')) {
            if($('.affix-menu').length){
                $('.lang-tabs').css('top', $('.affix-menu').outerHeight());
            }
            else {
                $('.lang-tabs').css('top', '0');
            }
